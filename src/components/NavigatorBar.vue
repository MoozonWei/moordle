<template>
  <div class="navbar-wrapper">
    <div class="game-button help-button" @click="store.pages.showHelp = !store.pages.showHelp">
    ...
    <div class="app-name"><span>Moo</span>rdle</div>
    <div class="game-button statistics-button" @click="store.pages.showStatistics = !store.pages.showStatistics">
      <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
        <path fill="#878a8c" d="M16,11V3H8v6H2v12h20V11H16z M10,5h4v14h-4V5z M4,11h4v8H4V11z M20,19h-4v-6h4V19z"></path>
      </svg>
    </div>
    <div class="game-button setting-button" v-if="false">
      <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
